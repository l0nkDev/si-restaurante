        ...
        <div class="mt-6">
            <div style="margin: 20px;">
                <div class="flex flex-row justify-between">
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Administración de
                        empleados</h2>
                    <form method="GET" action="{{ route('empleados.create') }}">
                        <x-primary-button class="mt-4"
                                          style="margin-right: 2px">{{ __('NUEVO EMPLEADO') }}</x-primary-button>
                    </form>
                </div>
                <div class="mt-6 bg-white rounded-lg divide-y">
                    ...
                    <table style="width: calc(100% - 32px); margin: 16px;">
                        ...
                        @foreach($empleados as $empleado)
                                <?php $persona = \App\Models\Admin\Persona::find($empleado->IdEmpleado) ?>
                            <tr>
